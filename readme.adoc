...
Everything is transparent and peer review is welcome, espacially regarding security aspects. Hopefully, the concepts may help others in a similar environment.
