...
* Go to menu *L2 Features > VLAN > VLAN Interface*.
* Choose a Unit 1 on drop-down box.
* On the Unit 1 Settings table choose port X (eth1/0/X) and tick Edit.
* Choose a *VLAN Mode* = *X*. Leave an Acceptable Frame = Admit All. Leave Ingress Checking = Enabled.
* Tick apply.
