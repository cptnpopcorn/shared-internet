...
image::Configure_VLAN_Interface_Host_window[opts=inline,width=800]
...
image::Configure_VLAN_Interface_Trunk_window[opts=inline,width=800]
...
image::Private_VLAN_window[opts=inline,width=800]
...
image::DHCP_Snooping_Binding_real_tracking_example[opts=inline,width=800]
