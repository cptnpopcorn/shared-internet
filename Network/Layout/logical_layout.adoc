...
|2400
|public services: IoT / relays (controlled by services.eco, isolated from shared internet clients)
...
|Nokia XS-010X-Q 		   	.14+|Local Elec A (Tines 3C)	|bridge				|11
...
|Relay (extracteur)                                         |10.137.0.10/16		|2400
