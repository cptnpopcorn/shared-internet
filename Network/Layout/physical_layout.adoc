...
|===
|Location |Inventory Code |Type |Ports |Link |VLAN ID
...
|
|19 (SFP)
|Local Principal SIN / OTO B.194.220.330.6
|
...
|
|17
|Compteur Photovoltaique Local Elec
|
...
|
|16
|Local MCR B Centrale Lecture Neovac
|
...
|
|15
|Local Sprinkler Centrale d'alarme Sprinkler
|
...
|
|12
|Chaufferie Boitier de cascade
|

|
|TBD
|Modem Genexis DRG7000
|TBD
|SW3-005
|100
